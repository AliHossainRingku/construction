...
<tr>
<td>
<p>A new query has been submitted from <b><u>{name}</u></b> through the website. Please check the information below:-</p>
</td>
</tr>
<tr>
...
$finds   = array('{name}','{email}','{phone}','{query}');
$replace = array($_POST['name'],$_POST['email'],$_POST['phone'],$_POST['query']);
...
$mail->Subject = 'New FAQ Query'; // Mail Title Subject
