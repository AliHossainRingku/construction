...
@section('admin_content')
    ...
    <form class="form-horizontal" action="{{URL::to('admin/departments/'.$department->id)}}" method="post" enctype="multipart/form-data" name="editForm">
        {{csrf_field()}}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="file" class="form-control" id="department_image" name="department_image">
        </div>
    </div>
